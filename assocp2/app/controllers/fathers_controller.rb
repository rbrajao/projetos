class FathersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @father.save
        format.html { redirect_to father_url(@father), notice: "Father was successfully created." }
  ...
  def update
    respond_to do |format|
      if @father.update(father_params)
        format.html { redirect_to father_url(@father), notice: "Father was successfully updated." }
